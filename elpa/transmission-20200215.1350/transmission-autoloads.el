...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "transmission" '("define-transmission-" "download>?" "eta>=?" "percent-done>?" "ratio>?" "size" "transmission-" "upload>?")))
