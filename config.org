...
Get some things out of the way early.  Without [[*Use-package and dependencies][use-package]], none of
this config would work.

** Use-package and dependencies

[[info:use-package#Top][use-package]] is a very powerful macro that allows you to control how a
package is loaded, and when certain configurations are evaluated.  It
is included in Emacs since version 29.1, along with =bind-key=, though
in the past I have had to install them separately.

I will use =use-package='s [[info:use-package#Delight][:delight]] keyword throughout this config file,
so I install that here as well.
...
Here, I include [[https://melpa.org][MELPA]] in the [[help:package-archives][package-archives]] variable.  A lot of
valuable packages have now been included in the NonGNU archive--but
there are still a few that only exist in MELPA, and I'd rather not be
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (:map org-mode-map
          ("C-c C-v h" . org-fold-hide-block-all)
          ("M-h" . mark-paragraph)
...
#+begin_src emacs-lisp
  (use-package ox-publish
    ...
    (use-package ox-jamzattack
      :demand
      :vc (:url "https://github.com/jamzattack/ox-jamzattack"))
...
#+begin_src emacs-lisp :tangle no
  (use-package maori-input-method
    :vc (:url "https://github.com/jamzattack/maori-input-method"))
#+end_src
...
#+begin_src emacs-lisp :tangle no
  (use-package shavian-input-method
    :vc (:url "https://github.com/jamzattack/shavian-input-method"))
#+end_src
...
This is where ELPA packages are listed.  Some of these aren't in the
ELPA archives, so I make use of the =use-package= [[info:use-package#Install package][:vc keyword]].

** epkg

Epkg is a library that interfaces with the [[https://emacsmirror.net][Emacsmirror]] database and
...
#+begin_src emacs-lisp
  (use-package lilypond-mode
    :vc (:url "https://github.com/jamzattack/lilypond-mode")
    :delight
...
#+begin_src emacs-lisp
  (use-package regexp-expand
    :vc (:url "https://github.com/danielmartin/regexp-expand")
    :bind
    (:map emacs-lisp-mode-map
...
#+begin_src emacs-lisp
  (use-package selime
    :vc (:url "https://github.com/jamzattack/selime")
    :delight
...
#+begin_src emacs-lisp
  (use-package lex-hl
    :vc (:url "https://github.com/jamzattack/lex-hl")
    :bind
    (:map emacs-lisp-mode-map
...
#+begin_src emacs-lisp
  (use-package lilypond-auto-insert
    :vc (:url "https://github.com/jamzattack/lilypond-auto-insert")
    :after lilypond-mode
    :custom
...
#+begin_src emacs-lisp
  (use-package org-el-index
    :vc (:url "https://github.com/jamzattack/org-el-index")
    :after org
    :bind
    (:map org-mode-map
...
#+begin_src emacs-lisp
  (use-package ol-elpher
    :vc (:url "https://github.com/jamzattack/ol-elpher")
    :after ol)
#+end_src
...
#+begin_src emacs-lisp
  (use-package dimmer
    :vc (:url "https://github.com/gonewest818/dimmer.el"
  	    :rev :newest)
    :hook after-init
    :config
...
#+begin_src emacs-lisp
  (use-package edwina
    :vc (:url "https://gitlab.com/axgfn/edwina"
  	    :rev :newest)
    :defer t
    :config
...
#+begin_src emacs-lisp
  (use-package plumb
    :vc (:url "https://github.com/jamzattack/plumb")
    :bind
    ("C-z d" . plumb)
    ("C-z C-d" . plumb))
#+end_src
...
#+begin_src emacs-lisp
  (use-package narrow-x
    :vc (:url "https://github.com/jamzattack/narrow-x")
    :bind
    (:map narrow-map
...
#+begin_src emacs-lisp
  (use-package search-query
    :vc (:url "https://github.com/jamzattack/search-query")
    :custom
...
#+begin_src emacs-lisp
  (use-package insert-date
    :vc (:url "https://github.com/jamzattack/insert-date")
    :bind
...
#+begin_src emacs-lisp
  (use-package itch
    :vc (:url "https://github.com/jamzattack/itch")
    :bind
...
#+begin_src emacs-lisp
  (use-package eshell-outline
    :vc (:url "https://github.com/jamzattack/eshell-outline")
    :hook eshell-mode)
#+end_src
