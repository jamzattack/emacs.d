...
(defvar dwm-mode-emulate-keybindings nil
  "When non-nil, emulate dwm keybindings using the function
`load-dwm-mode-keybindings'")

(defun load-dwm-mode-keybindings ()
  "When non-nil, emulate dwm keybindings, using the super modifier.

Keybindings:
s-j:          `dwm-next-buffer'
s-k:          `dwm-prev-buffer'
s-S-c:        `delete-window'
s-<return>:   `dwm-next-buffer'"
  
  (interactive)
  (if dwm-mode
      (progn
        (global-set-key (kbd "s-j") 'dwm-next-buffer)
        (global-set-key (kbd "s-k") 'dwm-prev-buffer)
        (global-set-key (kbd "s-C") 'delete-window)
        (global-set-key (kbd "s-<return>") 'dwm-load-buffer))
...
(define-minor-mode dwm-mode
  "Enable tiled window managing ala dwm"
  ...
  (if dwm-mode
      (progn
        ...
        (advice-add 'switch-to-buffer :around 'switch-to-buffer)
  ...
  (when dwm-mode-emulate-keybindings
    (add-hook 'dwm-mode-hook 'load-dwm-mode-keybindings)))
