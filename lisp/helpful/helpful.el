...
;; Keywords: help, lisp
;; Version: 0.18
;; Package-Requires: ((emacs "25") (dash "2.12.0") (dash-functional "1.2.0") (s "1.11.0") (elisp-refs "1.2"))
...
source code to primitives."
  (let ((emacs-src-dir (read-directory-name "Path to Emacs source code: ")))
    ...
    (unless (equal (file-name-nondirectory emacs-src-dir) "src")
...
If .elc files exist without the corresponding .el, return nil."
  (when (member (file-name-extension library-name) '("c" "rs"))
    (setq library-name
	   ...
	   library-name
	   (directory-file-name
	    (file-name-directory find-function-C-source-directory)))))
  (condition-case nil
