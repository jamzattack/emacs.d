...
#+begin_src emacs-lisp
  (use-package elfeed
    ...
    (:map elfeed-show-mode-map
          ...
          ("M-n" . forward-paragraph))
    :config
    (load-file (expand-file-name "lisp/elfeed-macro.el" user-emacs-directory))
    (elfeed-update))
#+end_src
...
#+begin_src emacs-lisp :tangle (expand-file-name "lisp/elfeed-macro.el" user-emacs-directory)
