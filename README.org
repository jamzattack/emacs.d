...
Define a couple of slime-like keys, make the scratch buffer use
emacs-lisp-mode.
...
I'm trying to get into EMMS.  I will keep [[MPDel]] for a while, until I
get used to it.

#+begin_src emacs-lisp
  (use-package emms-player-mpd
    :ensure emms
    :custom ((emms-player-list '(emms-player-mpd))
